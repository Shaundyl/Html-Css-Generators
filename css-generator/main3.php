...
$cssGen->addFormat($format1)
    ...
    // No media query needed in this case, comment out the section
    // $media1 = new CSSMedia(390, 'MAX_WIDTH', true);
    // $media1->addFormat($format1)->addFormat($format2)->addFormat($format3);
    // $cssGen->addMedia($media1);
